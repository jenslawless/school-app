...
function NavBar({ currentUser, setIsLoggedIn, setCurrentUser }) {
  ...
  return (
    <div className="flex flex-col fixed left-0 items-center w-20 pt-8 h-screen text-gray-700 bg-zinc-600 m-0">
      ...
      <p className="  items-center text-s text-gray-300  ">Courses</p>
      {/* 3 - Tasks */}
      <div className="flex flex-col items-center border-t border-gray-300">
        <a
          className="flex items-center justify-center w-12 h-12 m-2 bg-neutral-300 hover:bg-white"
      ...
      <p className="  items-center text-s text-gray-300  ">Tasks</p>
      <div className="flex flex-col items-center border-t border-gray-300">
        <a
          className="flex items-center justify-center w-12 h-12 m-2 bg-neutral-300 hover:bg-white"
          href="#"
      ...
      <p className="  items-center text-s text-gray-300  ">Calendar</p>
      <div className="flex flex-col items-center border-t border-gray-300">
        <a
          className="flex items-center justify-center w-12 h-12 m-2 bg-neutral-300 hover:bg-white"
          href="#"
      ...
      <p className=" items-center text-s text-gray-300 ">Messages</p>
      <div className="flex flex-col items-center border-t border-gray-300">
        <a
          className="flex items-center justify-center w-12 h-12 m-2 bg-neutral-300 hover:bg-white"
          href="#"
